export async function onRequestPost(context) {
  ...
  const html = `
    ...
    <a href="https://www.prosperitylfs.com" target="_blank" style="text-decoration:none;">
      <img src="https://www.prosperitylfs.com/images/Loretta%20email%20signature.png" width="520" style="width:520px; max-width:100%; height:auto; display:block; border:0; margin-top:24px;" alt="Loretta Stewart - Prosperity Life & Financial Solutions" />
    </a>
  `;
